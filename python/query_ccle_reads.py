...
def main ( args ):
    ...
    if ( args.verbose ):
        ...
        try:
            r = apiSvc.cohort_endpoints().cohorts().patient_details ( patient_barcode=aPatient ).execute()
            # print json.dumps ( r, indent=4 )
        except:
            print " ERROR: patient_details endpoint call failed "
            sys.exit(-1)

        print " some patient details : "
        print "     project ....... ", r['clinical_data']['Project']
        print "     study ......... ", r['clinical_data']['Study']
        print "     patient id .... ", r['clinical_data']['ParticipantBarcode']
        print "     gender ........ ", r['clinical_data']['gender']
        print "     tumor site .... ", r['clinical_data']['tumor_tissue_site']
        print "     histology ..... ", r['clinical_data']['histological_type']
    ...
    for aPatient in patientList:
        ...
        try:
            ...
            print " ERROR: patient_details endpoint call failed ... continuing to next patient "
            continue
        ...
        for aSample in sampleList:
            ...
            try:
                r = apiSvc.cohort_endpoints().cohorts().sample_details ( sample_barcode=aSample ).execute()
                if ( args.verbose ): print json.dumps ( r, indent=4 )
            except:
                print " ERROR ??? sample_details endpoint call failed ... continuing anyway "
                continue
            ...
            try:
                ...
                for aData in data_details:
                    ...
                    if ( aData['GG_readgroupset_id']!='None' and aData['GG_readgroupset_id']!='' ):

...
class ParametrizedApiTest(unittest.TestCase):
	def __init__(self, methodName="runTest", config=None, config_dir=None, num_requests=None, auth=None):
		...
		self.config = config # this is the "type" of configuration for the test (one of "minimal", "missing_required_params", "optional_params", "undefined_params", "incorrect_param_types")
		self.config_dir = config_dir # this is the location of the requests which match the given configuration
